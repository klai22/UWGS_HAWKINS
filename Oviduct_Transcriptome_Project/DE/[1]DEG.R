...
#Even after trying to filter by 0.01 padj, there was too much data, so I am just going to take the TOP 20 rows for now (20 genes w/ GREATEST |logFC|)
...
# save to pdf
pdf("[6]DEG1.pdf", width=10,height=8)
print(DEG)
dev.off()
